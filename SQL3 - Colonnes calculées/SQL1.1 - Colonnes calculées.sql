...
SELECT productName, productVendor, quantityInStock, (MSRP - buyPrice) AS margin /*AS variable temporaire*/
FROM products
...
SELECT orderNumber, customerNumber, DATEDIFF(shippedDate, orderDate) AS processTime
FROM orders
WHERE customerNumber BETWEEN 250 AND 350
HAVING processTime < 4
